...
<div class="container">
  ...
  <div class="panel-body">
        <h4> Inicio... Da una vista de todos los resultados que se hayan expedido, sin importar el paciente y ordenados por fecha</h4> <h3>expedidos y en espera</h3>
  </div>
</div>
 <div class="container">
<h3>Resultados expedidos</h3>
   <table class="table table-striped table-hover table-responsive">
      <thead>
        <tr><th>Nombre</th><th>Correo</th><th>Fecha</th><th>Tipo de Analisis</th></tr>
      </thead>
      <tbody>
      <?php 
        for($i = 0; $i<10; $i++){
          ?> 
        <tr><td>Juan López</td><td>Juan@hotmail.com</td><td>26/07/2016</td><td>De gripe</td></tr>
          <?php
        }
      ?> 
      </tbody>
