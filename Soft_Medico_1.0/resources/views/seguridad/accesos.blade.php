...
<div class="container">
  ...
  <div class="panel-body">
        <h4> Inicio... Para atender el pedo de la seguridad: llevar un registro de los logeos de los doctores y para tener un poco más de información, los historiales de quién revisó</h4>
  </div>
</div>
 <div class="container">
<h3>Accesos</h3>
   <table class="table table-striped table-hover table-responsive">
      <thead>
        <tr><th>Usuario</th><th>Fecha</th><th>Archivos abiertos</th></tr>
      </thead>
      <tbody>
      <?php 
        for($i = 0; $i<10; $i++){
          ?> 
        <tr><td>Juan López</td><td>26/07/2016</td><td>Elver Galarga</td></tr>
          <?php
        }
      ?> 
      </tbody>
