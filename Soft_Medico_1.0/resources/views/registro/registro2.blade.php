...
<div class="alert alert-success" role="alert">
  <a href="#" class="alert-link">El análisis se ha registrado con éxito</a>
</div>


<div class="container">   

 <h3>Seleccione el tipo de análisis</h3> 
      <div class="list-group">
        <a href="#" class="list-group-item active">
        <h4 class="list-group-item-heading">Sangre</h4>
        <p class="list-group-item-text">$300</p>
        <p class="list-group-item-text">3 horas de espera</p>
    </a>
  </div>

  <div class="list-group">
    <a href="#" class="list-group-item">
     <h4 class="list-group-item-heading">Aálisis completo</h4>
     <p class="list-group-item-text">$300</p>
     <p class="list-group-item-text">3 horas de espera</p>
    </a>
   </div>
    ...
    <div class="list-group">
      <a href="#" class="list-group-item">
      <h4 class="list-group-item-heading">De orina</h4>
      <p class="list-group-item-text">$300</p>
      <p class="list-group-item-text">3 horas de espera</p>
    </a>
  </div>
<a href="/pacientes/registro">Atrás</a>
</div>
</div>
