...
<div class="container">
  ...
  <div class="panel-heading">Envío de información</div>
...
<h3>Correos enviados</h3>
   <table class="table table-striped table-hover table-responsive">
      <thead>
        <tr><th>Nombre</th><th>Correo</th><th>Fecha</th><th>Acción</th></tr>
      </thead>
      <tbody>
      <?php 
        for($i = 0; $i<5; $i++){
          ?> 
        <tr><td>Juan López</td><td>Juan@hotmail.com</td><td>22/07/2016</td><td><button class="btn">Reenviar</button></td></tr>
          <?php
        }
      ?> 
      </tbody>
